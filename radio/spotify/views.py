...
class Login(APIView):
    def get(self, request, fornat=None):
        scopes = 'user-top-read streaming user-read-email user-read-private user-library-read user-library-modify user-read-playback-state user-modify-playback-state'
